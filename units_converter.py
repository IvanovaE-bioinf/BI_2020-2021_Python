<<<<<<< HEAD
print("Конвертер величин (vesa, площади, температуры).")
=======
print("Конвертер величин (massy, площади, температуры).")
>>>>>>> second-homework
print("Введите значение и единицы измерения (кг, г, мг, мкг, ц, т; м^2, км^2, га, а, дм^2, см^2, мм^2; Ц, К, Ф):")
my_num, my_num_units = input().split()
my_num = float(my_num)
d1 = {'кг': 1, 'г': 1000, 'мг': 1000000, 'мкг': 1000000000, 'ц': 0.01, 'т': 0.001}  # коэффициенты пересчета
d2 = {'м^2': 1, 'км^2': 0.000001, 'га': 0.0001, 'а': 0.01, 'дм^2': 100, 'см^2': 10000, 'мм^2': 1000000}
d3 = ['Ц', 'К', 'Ф']
